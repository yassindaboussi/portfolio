...
export const projects: Project[] = [
  {
    ...
    company: 'Freelance',
    type: 'web',
    desc: 'Plateforme d’assurance digitale complète',
    fullDescription:
    "SmartAssur est une plateforme d’assurance digitale full-stack permettant de gérer l’ensemble du parcours assurantiel, de la souscription à la gestion des sinistres. La plateforme offre une expérience fluide avec souscription en ligne, paiements sécurisés via Stripe, signatures électroniques, génération automatique de documents PDF, notifications par email et tableau de bord d'administration complet. Conçue avec une architecture orientée microservices, elle met l'accent sur la sécurité, la maintenabilité et la scalabilité. Plus de 60 tests unitaires et d'intégration couvrent les fonctionnalités critiques afin de renforcer la qualité et la fiabilité du système.",
    tech: [
    'Next.js 14',
    'Node.js',
    'Express',
